...
// @ts-ignore
import { createResultProblemFromDiscriminatorValue, createSuccessResponseFromDiscriminatorValue, serializeRunCommandRequest, serializeSuccessResponse, type ResultProblem, type RunCommandRequest, type SuccessResponse } from '../models/index.js';
// @ts-ignore
...
export interface RunCommandRequestBuilder extends BaseRequestBuilder<RunCommandRequestBuilder> {
     ...
     */
     post(body: RunCommandRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SuccessResponse | undefined>;
    /**
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const RunCommandRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createSuccessResponseFromDiscriminatorValue,
